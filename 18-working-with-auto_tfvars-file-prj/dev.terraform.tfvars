...
ec2_volume_config = {
  ...
  type = "gp3" # General purpose SSD volume type with good performance/cost balance.
}
...
additional_tags = {
  ValuesFrom = "dev.terraform.tfvars" # Indicates these values were sourced from this file.
}
